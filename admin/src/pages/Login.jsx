...
const Login = () => {
  const { login, loading, error, clearError, isAuthenticated } = useContext(AppContext);
          ...
          <div className="relative z-10 flex flex-col justify-center px-12 xl:px-16 text-white">
            <div className={`transform transition-all duration-1000 ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'}`}>
              <div className="flex items-center gap-4 mb-6">
                ...
                <h1 className="text-2xl xl:text-3xl font-bold">BusTrac Admin</h1>
              </div>
              ...
              <p className="text-lg xl:text-xl text-slate-300 mb-6 xl:mb-8 leading-relaxed">
                Manage your bus fleet, drivers, and routes with powerful administrative tools and real-time analytics.
              </p>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-slate-300 text-sm xl:text-base">Fleet management dashboard</span>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-slate-300 text-sm xl:text-base">Driver & bus management</span>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-slate-300 text-sm xl:text-base">Real-time analytics</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-6 lg:p-8 xl:p-12 h-full overflow-y-auto">
          <div className="w-full max-w-md flex flex-col justify-center min-h-0">
            ...
            <div className="lg:hidden text-center mb-4 sm:mb-6 flex-shrink-0">
              ...
              <h1 className="text-xl sm:text-2xl font-bold text-slate-900">BusTrac Admin</h1>
            </div>
