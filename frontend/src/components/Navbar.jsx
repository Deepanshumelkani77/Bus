      ...
      <div className="max-w-6xl mx-auto px-5 lg:px-8">
        <div className="flex justify-between items-center h-16 lg:h-18">
          ...
          <Link to="/" className="flex items-center gap-3 text-gray-800 hover:text-gray-700 transition-colors">
            <div className="w-10 h-10 lg:w-12 lg:h-12 bg-slate-900 rounded-full flex items-center justify-center shadow-lg">
          ...
          <div className="hidden lg:flex items-center gap-8">
            ...
            <Link 
              to="/login" 
              className="bg-slate-900 text-white px-6 py-2.5 rounded-full font-semibold hover:bg-slate-800 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
            >
              Login
            </Link>
          </div>
        ...
        {isMenuOpen && (
          <div className="lg:hidden border-t border-gray-200 py-4 space-y-4 bg-white">
            ...
            <Link 
              to="/login" 
              className="inline-block bg-slate-900 text-white px-6 py-2.5 rounded-full font-semibold hover:bg-slate-800 transition-all duration-300 shadow-lg mt-2"
